	...
	{{Form::open([
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Добавляем заявку</h3>
 ...
 <!-- Date -->
            ...
            <div class="form-group">
              ...
              {{Form::select('company_id',
              	$companies,
              	null,
              	['class' => 'form-control select2','placeholder'=>'Выберите компанию'])
              }}
            </div>
            <div class="form-group">
              <label>Филия</label>
              {{Form::select('filia_id',
              	$filia,
              	null, 
              	['class' => 'form-control select2','placeholder'=>'Выберите филию'])
              }}
            </div>
           <div class="form-group">
                       <label for="exampleInputFile">Сканкопия заявки</label>
